<template>
  <form class="buy form">
    ...
    />
    <action-button :button-class="buttonClass" @button-click="handleExecuteBuy">
      {{ $t('nibbleShop.btnBuy.simple') }}
    </action-button>
  </form>
</template>
