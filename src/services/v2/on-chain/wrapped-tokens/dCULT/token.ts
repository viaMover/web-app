...
export class WrappedTokenDCult implements IWrappedToken {
  ...
  constructor(network: Network) {
    ...
    this.sentryPrefix = `wrapped-token.dcult`;
    this.wrappedTokenAddress = lookupAddress(network, 'DCULT_TOKEN_ADDRESS');
  }

  getUnwrappedToken = (): SmallTokenInfo => getCULTAssetData(this.network);
